            ...
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><?php
                            include '../include/koneksi.php';
                            $pekerjaan_id = htmlspecialchars($data['pekerjaan_id']);
                    ...
                    <tr>
                        <th>Kecamatan</th>
                        <td><?php echo htmlspecialchars($data['kecamatan_id']); ?></td>
                    </tr>
                    <tr>
                        <th>No Komponen</th>
                ...
                <form method="post" class="mt-3">
                    ...
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalTolakChat">
                        <i class="fas fa-times"></i> Tolak
                    </button>
                    <a href="berkas_skck.php" class="btn btn-secondary ms-2">Kembali</a>
