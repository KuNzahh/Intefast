...
$sql_user = "SELECT u.email, u.nama FROM users u JOIN sttp s ON u.id_user = s.user_id WHERE s.user_id = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        echo '<p><a href="berkas_sttp.php" style="color: #155724; font-weight: bold; text-decoration: none;">Kembali ke Berkas STTP</a></p>';
        echo '</div>';
    } catch (Exception $e) {
        ...
        echo '<p><a href="berkas_sttp.php" style="color: #721c24; font-weight: bold; text-decoration: none;">Kembali ke Berkas STTP</a></p>';
        echo '</div>';
    }
} else {
?>
        ...
        <div class="container">
            ...
            <form method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="judul_email" id="judul_email" value="Notifikasi Berkas STTP Sudah Selesai" required>
                </div>
                <div class="form-group">
                    <label for="isi_email">Isi Email:</label><br>
                    <textarea name="isi_email" id="isi_email" rows="5"><?php echo 'Yth. ' . htmlspecialchars($nama_penerima) . ",<br><br>Berkas STTP Anda Diterima, Anda bisa unduh Berkas Online di APLIKASI INTELFAST atau dapat diambil Fisiknya di SPKT POLRES BARITO KUALA.<br><br>Terima kasih."; ?></textarea><br><br>
                </div>
                <input type="submit" value="Kirim Notifikasi">
            </form>
            <div class="kembali-container">
                <a href="berkas_sttp.php" class="kembali">Kembali ke Berkas STTP</a>
            </div>
        </div>
    </body>
