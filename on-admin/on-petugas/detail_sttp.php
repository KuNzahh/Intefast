        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form method="post" class="mt-3">
                    <button type="button" class="btn btn-success me-2" data-bs-toggle="modal" data-bs-target="#modalTerimaSttp">
                        <i class="fas fa-check"></i> Terima
                    </button>
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalTolakChatSttp">
                        <i class="fas fa-times"></i> Tolak
                    </button>
                    <a href="berkas_sttp.php" class="btn btn-secondary ms-2">Kembali</a>
